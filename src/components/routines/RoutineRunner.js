...
import FretboardTriads from '../fretboardTriads/FretboardTriads';
...
import ChordEarTrainer from '../earTraining/chordRecognition/ChordEarTrainer';
import ProgressionEarTrainer from '../earTraining/progressionRecognition/ProgressionEarTrainer';
...
import PentatonicQuiz from '../pentatonic/PentatonicQuiz';
import ScaleDegreeQuiz from '../scaleDegreeQuiz/ScaleDegreeQuiz';

const getComponentForPreset = (preset, props) => { if (!preset || !preset.gameId) return null; switch (preset.gameId) { case 'caged-system-quiz': return <CAGEDSystemQuiz {...props} />; case 'fretboard-triads': return <FretboardTriads {...props} />; case 'chord-trainer': return <ChordTrainer {...props} challengeSettings={preset.settings} />; case 'interval-ear-trainer': return <IntervalEarTrainer {...props} />; 
case 'melodic-ear-trainer': return <MelodicEarTrainer {...props} />;
case 'chord-ear-trainer': return <ChordEarTrainer {...props} />;
case 'progression-ear-trainer': return <ProgressionEarTrainer {...props} />; case 'interval-fretboard-quiz': return <IntervalFretboardQuiz {...props} />; case 'intervals-quiz': return <IntervalsQuiz {...props} />; case 'triad-quiz': return <TriadQuiz {...props} />; case 'chord-progression-generator': return <ChordProgressionGenerator />; case 'interval-generator': return <IntervalGenerator />; case 'note-generator': return <NoteGenerator />; case 'pentatonic-shapes-quiz': return <PentatonicQuiz {...props} />; case 'scale-degree-quiz': return <ScaleDegreeQuiz {...props} />; default: return <p>Error: Unknown game ID "{preset.gameId}"</p>; } };

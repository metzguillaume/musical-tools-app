...
case 'progression-ear-trainer': return <ProgressionEarTrainer {...props} />; case 'interval-fretboard-quiz': return <IntervalFretboardQuiz {...props} />; case 'intervals-quiz': return <IntervalsQuiz {...props} />; case 'triad-quiz': return <TriadQuiz {...props} />; case 'chord-progression-generator': return <ChordProgressionGenerator />; case 'interval-generator': return <IntervalGenerator />; case 'note-generator': return <NoteGenerator />; case 'pentatonic-shapes-quiz': return <PentatonicQuiz {...props} />; default: return <p>Error: Unknown game ID "{preset.gameId}"</p>; } };
